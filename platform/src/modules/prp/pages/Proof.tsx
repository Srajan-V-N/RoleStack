...
import { Card } from '@/modules/prp/components/ui/Card';
import { Button } from '@/modules/prp/components/ui/Button';
          ...
          {([
            ...
            <div key={field}>
              ...
              <input
                ...
                placeholder="https://..."
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm transition-colors focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/50"
              />
              {showError(field) && (
